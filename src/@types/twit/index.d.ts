...
// Modified by Omar Jbara <https://github.com/Liinkiing> to support Twitter new APIs changes
...
declare module 'twit' {
  ...
  namespace Twit {
    ...
    export namespace Twitter {
      ...
      export interface MediaEntityVariant {
        bitrate: number,
        content_type: string,
        url: string
      }
      export interface ExtendedMediaEntity extends MediaEntity {
        video_info: {
          duration_millis: number,
          variants: MediaEntityVariant[]
        }
      }
      ...
      export interface ExtendedEntities extends Entities{
    ...
    export type Callback = (err: Error, result: Response, response: IncomingMessage) => void
  ...
  class Twit {
     ...
     */
    public get(path: string, callback: Twit.Callback): void;
    public get(path: string, params: Twit.Params, callback: Twit.Callback): void;
    public get(path: string, params?: Twit.Params): Promise<Twit.PromiseResponse>;

    /**
     * @see https://github.com/ttezel/twit#tpostpath-params-callback
     */
    public post(path: string, callback: Twit.Callback): void;
    public post(path: string, params: Twit.Params, callback: Twit.Callback): void;
    public post(path: string, params?: Twit.Params): Promise<Twit.PromiseResponse>;

    /**
     * @see https://github.com/ttezel/twit#tpostmediachunkedparams-callback
     */
    public postMediaChunked(media: Twit.MediaParam, callback: Twit.Callback): void;

    /**
     * @see https://github.com/ttezel/twit#tgetauth
     */
    public getAuth(): Twit.Options

    /**
     * @see https://github.com/ttezel/twit#tsetauthtokens
     */
    public setAuth(tokens: Twit.ConfigKeys): void

    /**
     * @see https://github.com/ttezel/twit#tstreampath-params
     */
    public stream(path: Twit.StreamEndpoint, params?: Twit.Params): Twit.Stream;
  }
